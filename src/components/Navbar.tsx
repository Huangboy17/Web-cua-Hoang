        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              title="Chỉnh sửa thông tin hồ sơ & liên kết Web App"
              className={`p-2 sm:px-3.5 sm:py-1.5 rounded-full text-xs font-medium flex items-center gap-1.5 transition-all ${
                darkMode 
                  ? 'bg-white/5 hover:bg-white/10 text-[#F8FAFC] border border-white/10 hover:border-[#7C3AED]/50' 
                  : 'bg-white hover:bg-slate-100 text-[#0F172A] border border-[#E2E8F0] shadow-sm'
              }`}
            >
